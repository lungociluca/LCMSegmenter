...
import json
import time
from local_config import device, context_path, batch_size, limit_no_of_batches
...
def compute_masks(args, data_loader, batch_limiter):
    ...
    output_path=f'./output/voc10_wo_sy_norm'
                    ...
                    if current_label_idx == 0:
                        ...
                        for idx in range(images.shape[0]):
                            ...
                            try:
                                ...
                                print('value error')
                                print('label', image_label, 'embs', embs[:60])
                                exit(0)
